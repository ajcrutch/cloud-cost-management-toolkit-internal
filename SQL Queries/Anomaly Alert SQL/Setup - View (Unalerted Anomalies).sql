/*
This file creates the view that finds anomalies which have not
yet been successfully alerted on.
This version includes logic for custom thresholds and ranked alert logs.
*/

-- ============================================================================
-- Create Unalerted Anomalies View
-- ============================================================================
CREATE OR REPLACE VIEW `<project_id>.<dataset>.vw_unalerted_anomalies` AS
WITH
...
SELECT
  ...
  metrics.total_net_cost AS total_net_cost,
